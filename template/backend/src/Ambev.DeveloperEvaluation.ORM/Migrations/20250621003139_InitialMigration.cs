        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), 12.4m, "Product D" },
                    { new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), 13.1m, "Product E" },
                    { new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"), 7.63m, "Product F" }
                });
